...
with Diagram("Projectv4",  filename= os.path.join( workingDirectory , "architecture/results/architecture-final" ) , show=True, direction="LR"):
    ...
    with Cluster("External API (internet)", direction="TB"):
